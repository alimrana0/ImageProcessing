 ...
 */
public class ImageProcessorGUIController implements ImageController, IViewListener {
   ...
   */
  public ImageProcessorGUIController(IImageProcessingSession model)
  ...
  private BufferedImage getTopVisibleLayer() {
    for (Map.Entry<String, ImageOfPixel> layer : this.model.getLayers().entrySet()) {
   ...
   */
  private BufferedImage generateImage(ImageOfPixel image) {
   ...
   */
  private void addHandler(String layerName, ImageOfPixel image) {
    try {
